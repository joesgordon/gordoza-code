...
/*******************************************************************************
 * Runtime exceptions used to denote an incorrect format of data during I/O.
 ******************************************************************************/
public class RuntimeFormatException extends RuntimeException
{
     ...
     **************************************************************************/
    public RuntimeFormatException( String message )
    {
        super( message );
    }
     ...
     **************************************************************************/
    public RuntimeFormatException( String message, Throwable cause )
    {
        super( message, cause );
    }
}
